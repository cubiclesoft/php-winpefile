<?php
	...
	$g_artifact_rules = array(
		...
		array("path" => "dos_header.pe_offset", "op" => "==", "val" => 0, "name" => "dos/dos_only", "prefix" => false),
		...
		array("path" => "ne_header.program_flags", "op" => "&", "val" => WinPEFile::WIN16_NE_PROGRAM_FLAGS_GLOBAL_INIT, "name" => "16_ne/16_ne_program_flags_global_init", "prefix" => false),
		...
		array("path" => "ne_header.program_flags", "op" => "&", "val" => WinPEFile::WIN16_NE_PROGRAM_FLAGS_8086, "name" => "16_ne/16_ne_program_flags_8086", "prefix" => false),
		...
		array("path" => "ne_header.app_flags", "op" => "&=", "mask" => 0x03, "val" => WinPEFile::WIN16_NE_APP_FLAGS_TYPE_WINPMCOMPAT, "name" => "16_ne/16_ne_app_flags_type_winpmcompat", "prefix" => false),
		...
		array("path" => "ne_header.app_flags", "op" => "&", "val" => WinPEFile::WIN16_NE_APP_FLAGS_NON_CONFORM, "name" => "16_ne/16_ne_app_flags_non_conform", "prefix" => false),
		...
		array("path" => "ne_header.target_os", "op" => "==", "val" => WinPEFile::WIN16_NE_TARGET_OS_DOS4, "name" => "16_ne/16_ne_target_os_dos4", "prefix" => false),
		...
		array("path" => "ne_header.os2_exe_flags", "op" => "&", "val" => WinPEFile::WIN16_NE_OS2_EXE_FLAGS_LFN, "name" => "16_ne/16_ne_os2_exe_flags_lfn", "prefix" => false),
		array("path" => "ne_header.os2_exe_flags", "op" => "&", "val" => WinPEFile::WIN16_NE_OS2_EXE_FLAGS_PROTECTED_MODE, "name" => "16_ne/16_ne_os2_exe_flags_protected_mode", "prefix" => false),
		array("path" => "ne_header.os2_exe_flags", "op" => "&", "val" => WinPEFile::WIN16_NE_OS2_EXE_FLAGS_PROPORTIONAL_FONTS, "name" => "16_ne/16_ne_os2_exe_flags_proportional_fonts", "prefix" => false),
		...
		array("path" => "pe_header.machine_type", "op" => "==", "val" => WinPEFile::IMAGE_FILE_MACHINE_SH3, "name" => "pe_machine_hitachi_sh3", "rare" => "64_pe"),
		...
		array("path" => "pe_header.machine_type", "op" => "==", "val" => WinPEFile::IMAGE_FILE_MACHINE_POWERPC, "name" => "pe_machine_ibm_powerpc_little", "rare" => "64_pe"),
		...
		array("path" => "pe_opt_header.subsystem", "op" => "==", "val" => 4, "name" => "pe_subsystem_win_ce_subsystem_4", "rare" => "64_pe"),
		...
		array("path" => "pe_opt_header.subsystem", "op" => "==", "val" => 9, "name" => "pe_subsystem_win_ce_subsystem_9", "rare" => "64_pe"),
		...
		"pe_sections" => array(
			...
			array("path" => "flags", "op" => "&=", "mask" => 0x00F00000, "val" => WinPEFile::IMAGE_SCN_ALIGN_128BYTES, "name" => "pe_sections_flags_align_128"),
		...
		"pe_data_dir.base_relocations.blocks" => array(
			"offsets" => array(
				...
				array("path" => "type", "op" => "==", "val" => WinPEFile::IMAGE_REL_BASED_LOW, "name" => "pe_data_dir_base_relocations_offset_low"),
				array("path" => "type", "op" => "==", "val" => WinPEFile::IMAGE_REL_BASED_HIGHLOW, "name" => "pe_data_dir_base_relocations_offset_highlow"),
				array("path" => "type", "op" => "==", "val" => WinPEFile::IMAGE_REL_BASED_HIGHADJ, "name" => "pe_data_dir_base_relocations_offset_highadj"),
				array("path" => "type", "op" => "==", "val" => WinPEFile::IMAGE_REL_BASED_MIPS_JMPADDR, "name" => "pe_data_dir_base_relocations_offset_5_mips_jmpaddr"),
